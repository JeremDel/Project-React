...
const questionnaire = {
  "themes": [
          ...
          "true/false": [
            {
				"label": "Yes",
				"question" : {
					"label": "Would you say you are active for at least 30 minutes each day (at least 5 days a week)?",
					"true/false": [
					  {
						"label": "Do you sometimes/regularly get sweaty or out of breath during this activity?",
						"true/false": [
						  {
							"label": "Yes",
							"points": 6,
							"recommendation": "It is very good, you are active at least 30 minutes a day 5 days a week. Keep it up!"
						  },
						  {
							"label": "No",
							"points": 5,
					  ...
					  },
					  {
						"label": "No",
						"points": 4,
						"recommendation": "It sounds like the intensity you put into your sport is too low. The next time you train, try to increase it."
					  }
					]
				}
            },
            {
				...
				"question":{
					...
					"label": "Would you like to resume more physical activity in the next few months?",
					"true/false": [
						{
							"label": "Yes",
							"points": 3,
						...
						"questions": [
							{
							"label": "Do you know the health benefits of physical activity?",
							"true/false": [
								{
								"label": "Yes",
								"choice": 1
						...
						"scoring": {
							...
							"points": 2,
							"recommendation": {
								"text": "We strongly encourage you to engage in regular activity. Here are some useful links to inform you about the benefits of physical activity.",
								"brochure": "brochuretropcool.com"
							}
							},
							"incorrect": {
								"points": 1,
								"recommendation": {
									...
									"brochure": [
									{
										"link": "brochureEncourage.com"
									},
									{
										"link": "brochureBenefice.com"
									}
									]
								}
							}
    ...
    },
    {
      ...
      "questions": [
        {
          "label": "Compared to the average walking speed (that of your family, friends and people your age), do you think you walk about... (check one)",
          "answers": [
            {
            ...
            },
            {
              ...
              "points": 3,
              "recommendation": "Suggestion: You do not need to increase or reduce the indicated time"
            },
            {
    ...
    },
    {
      ...
      "questions": [
        {
          "label": "Walk slowly (slower than your family, friends or people your age)",
          "answers": [
            {
              "label": "Impossible",
              "points": 0,
        ...
        {
          "label": "Walk at an average speed (the same speed as your family, friends or people your age)",
          "answers": [
            {
              "label": "Impossible",
              "points": 0
        ...
        {
          "label": "Walk fast (faster than your family, friends or people your age)",
          "answers": [
            {
              "label": "Impossible",
              "points": 0
    ...
    },
    {
      ...
      "recommendations": [
        {
          "recommendation": "No problems with balance or risk of falls; no suggestions necessary",
          "minPoint": 0
        },
        {
          "recommendation": "To propose paths without too much difficulty (risk of falls) and accompanied hikes",
          "minPoint": 1
        },
        {
    ...
    },
    {
      ...
      "questions": [
        {
          "label": "Do you feel confident when you stand on one leg without holding onto something?",
          "answers": [
            {
    ...
    },
    {
      ...
      "questions": [
        {
          "label": "Do you have mobility problems in one or more of the following joints?",
          "answers": [
            {
